...
def send_clinical_report(
    ...
    <div style="font-family:sans-serif;max-width:600px;margin:0 auto;">
      <div style="background:#16a34a;padding:32px 24px;border-radius:8px 8px 0 0;text-align:center;">
        <p style="color:#bbf7d0;font-size:13px;margin:0 0 4px;">Hospital Ampang Jaya</p>
        <h1 style="color:#ffffff;font-size:22px;margin:0;">Clinical Report</h1>
      </div>
      <div style="background:#ffffff;padding:28px 24px;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 8px 8px;">
        <p style="font-size:15px;color:#111827;margin:0 0 8px;">This report is prepared for: <b>{patient_name}</b></p>
        <p style="font-size:14px;color:#374151;margin:0 0 2px;">Hospital Ampang Jaya</p>
        <p style="font-size:14px;color:#374151;margin:0 0 20px;">{report_date}</p>
        <p style="font-size:14px;color:#374151;line-height:1.7;margin:0;">Your clinical screening report has been reviewed and approved by your doctor. The full report is attached to this email as a PDF document.</p>
        <div style="border-top:1px solid #f3f4f6;padding-top:16px;margin-top:24px;">
          <p style="font-size:12px;color:#2563eb;font-weight:bold;line-height:1.6;margin:0;">Please do not reply to this email. This message was automatically generated by the Visionary AI screening system. If you have any questions, please contact Hospital Ampang Jaya directly.</p>
        </div>
      </div>
    </div>
    """
    ...
    payload = {
        "from": "Visionary AI <onboarding@resend.dev>",
        "to": [patient_email],
        "subject": f"Your Clinical Report — {patient_name} ({datetime.now().strftime('%d %b %Y')})",
        "html": html,
    }
